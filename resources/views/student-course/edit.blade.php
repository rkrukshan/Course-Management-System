...
@section('body')
    <div class="container-fluid">
        <form action="{{ route('teacher.update',$teachers) }}" method="POST" class="form">
            @csrf
            @method('put')
            <table>
            ...
            <a class="link-light" href="{{route('teacher.index')}}"><button type="button" class="btn btn-secondary">Back</button></a>
