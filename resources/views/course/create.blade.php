    ...
    <div class="container-fluid">
        <form action="{{ route('course.store') }}" method="POST" class="form">
            ...
            <table>
                    ...
                    <input type="text" name="course_name"class="form-control" value="{{ old('course_name') }}"><br>
                    ...
                    @if($errors->has('course_name'))
                        ...
                        <input type="text" name="course_index"class="form-control" value="{{ old('course_index') }}"><br>
                        ...
                        <input type="text" name="course_order"class="form-control" value="{{ old('course_order') }}"><br>
