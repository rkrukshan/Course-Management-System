...
@section('body')
    <div class="container-fluid">
        <form action="{{ route('student.show',$students) }}" method="POST" class="form">
            @csrf
            @method('put')
            <table>
            ...
            <br>
            <a class="link-light" href="{{route('student.index')}}"><button type="button" class="btn btn-success">Back</button></a>
